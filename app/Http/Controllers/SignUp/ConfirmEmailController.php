...
class ConfirmEmailController extends Controller
{
    ...
    private function sendConfirmationLink($email)
    {
        ...
        dispatch(new \Infra\Jobs\ConfirmEmailJob(compact('email', 'name', 'token')));
    }

    public function sendConfirmRegister($email, $username, $name)
    {
        dispatch(new \Infra\Jobs\SendMailConfirmRegisterJob($email, $username, $name));
    }
    ...
    public function sendConfirmIndication($user)
    {
        ...
        dispatch(new \Infra\Jobs\SendMailConfirmIndicationJob($indicator->email, $indicator->name, $user->username));
    }
}
