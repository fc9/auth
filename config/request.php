...
return [
    ...
    'rules' => [
        ...
        'login' => 'bail|required|min:4|max:16|string|regex:/^(?![_.])(?!.*[_.]{2})[a-z0-9._]+(?<![_.])$/|exists:user,username',
        'message' => '',
        'minute' => '',
        'mobile' => '',
        'month' => '',
        ...
        'username' => 'bail|required|min:4|max:16|string|regex:/^(?![_.])(?!.*[_.]{2})[a-z0-9._]+(?<![_.])$/|unique:user',
        'year' => '',
        'zip_code' => 'max:16',
    ],
